...
int __cdecl main(int argc, wchar_t* argv[])
{
    ...
    PCWSTR description = L"MttVDD";

    // These match the Pnp id's in the inf file so OS will load the driver when the device is created    
    PCWSTR instanceId = L"MttVDD";
    PCWSTR hardwareIds = L"Root\\MttVDD\0\0";
    PCWSTR compatibleIds = L"MttVDD\0\0";
    ...
    // Create the device
    HRESULT hr = SwDeviceCreate(L"MttVDD",
        L"HTREE\\ROOT\\0",
        &createInfo,
        0,
        nullptr,
